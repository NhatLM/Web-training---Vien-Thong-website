...
function TableProduct(div_Contain_Table,ArrayShow,Index,SetWidth){
        var div_Container=$("<div class='TB_TablePrice_contaniner'></div>");
        if(SetWidth){div_Container.css("height","100%")}
    ...
    div_Contain_Table.append(div_Container)
    return {
                    container:div_Container,
                    captation:div_Captation,
                    price:div_Price,
                    plan:div_Plan,
                    attr:ul_Attr,
                    btn:a_Btn,
